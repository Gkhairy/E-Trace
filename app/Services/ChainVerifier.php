 ...
 * config/chain.php — kini BNB Smart Chain Testnet (chainId 97). Jaringan-agnostik:
 * ganti config, kelas ini ikut. Sumber kebenaran = on-chain; data dari browser
 * TIDAK dipercaya mentah.
 */
class ChainVerifier
{
    private string $rpc;
